        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center space-x-2 bg-brand-orange-500/10 border border-brand-orange-500/20 px-3 py-1 rounded-full text-brand-orange-500 text-xs font-bold uppercase tracking-wider">
              ...
              <span>{t("authorized_distributor", "Distribuidor Autorizado Holcim, Lanco, Truper y DeWalt")}</span>
            </div>
            
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-display font-extrabold tracking-tight leading-tight">
              {t("hero_title_1", "Sólido como tus cimientos,")}<br className="hidden sm:inline" />
              <span className="text-brand-orange-500"> {t("hero_title_2", "preciso como tus herramientas.")}</span>
            </h1>
            
            <p className="text-stone-300 text-sm md:text-base leading-relaxed max-w-xl">
              {t("hero_description", "En Grupo Ferretero Mora y Mora proveemos herramientas profesionales, material de construcción, plomería y electricidad para obras residenciales, comerciales e industriales.")}
            </p>
            ...
            <div className="flex flex-wrap gap-3.5 pt-2">
              ...
              >
                <span>{t("view_catalog_btn", "Ver Catálogo Interactivo")}</span>
              ...
              >
                <span>{t("calculatorsTab", "Calculadora de Materiales")}</span>
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white/5 backdrop-blur-xs border border-white/10 rounded-xl p-5 hover:border-brand-orange-500/30 transition-all group">
              ...
              <h3 className="text-base font-bold mt-4 mb-1.5 font-display text-white">{t("card_1_title", "Surtido Directo a Obra")}</h3>
              <p className="text-stone-400 text-xs leading-relaxed">
                {t("card_1_desc", "Flotilla propia para entregas rápidas y seguras en tu domicilio o zona de construcción.")}
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xs border border-white/10 rounded-xl p-5 hover:border-brand-orange-500/30 transition-all group">
              ...
              <h3 className="text-base font-bold mt-4 mb-1.5 font-display text-white">{t("card_2_title", "Precios Especiales")}</h3>
              <p className="text-stone-400 text-xs leading-relaxed">
                {t("card_2_desc", "Descuentos por volumen y precios de mayoreo para contratistas, albañiles e ingenieros.")}
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xs border border-white/10 rounded-xl p-5 hover:border-brand-orange-500/30 transition-all group">
              ...
              <h3 className="text-base font-bold mt-4 mb-1.5 font-display text-white">{t("card_3_title", "Cotizador Formal")}</h3>
              <p className="text-stone-400 text-xs leading-relaxed">
                {t("card_3_desc", "Genera cotizaciones oficiales con desglose de IVA y validez legal en menos de un minuto.")}
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xs border border-white/10 rounded-xl p-5 hover:border-brand-orange-500/30 transition-all group">
              ...
              <h3 className="text-base font-bold mt-4 mb-1.5 font-display text-white">{t("card_4_title", "Calidad Garantizada")}</h3>
              <p className="text-stone-400 text-xs leading-relaxed">
                {t("card_4_desc", "Solo distribuimos marcas líderes con amplias garantías directo de fábrica.")}
              </p>
            </div>
