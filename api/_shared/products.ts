// Copia autocontenida del catálogo, usada solo por las funciones serverless de /api.
// Si actualizas los productos en src/data.ts, actualiza también este archivo.
